...
Regarding IC Controller: First add the title "Possible IC Controllers:", then provide only a list of manufacturers and ICs, each on a new line. Seperate this list with three new lines from the answer above.
"""
